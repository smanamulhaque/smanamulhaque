...
<div style="display: flex; gap: 4px; border: 1px solid blueviolet; border-radius: 0; padding: 6px; max-width: fit-content;">
  ...
  <img src="https://skillicons.dev/icons?i=vscode" style="width:40px; height:40px; border:1px solid blueviolet; border-radius:0; padding:2px;"/>
  <img src="https://skillicons.dev/icons?i=linux" style="width:40px; height:40px; border:1px solid blueviolet; border-radius:0; padding:2px;"/>
